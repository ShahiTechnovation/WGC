...
function PartnerTree() {
  ...
  return (
    <div style={{ position: 'relative', padding: '40px 0', marginTop: '40px' }}>
      ...
      <div
        ...
        style={{
          ...
          right: '10%',
          height: '2px',
          background: 'rgba(170,223,46,0.2)',
          zIndex: 1
        }}
      />
          ...
          return (
            <div
              ...
              style={{
                ...
                alignItems: 'center',
                transform: `translateY(${isTopRow ? '-16px' : '16px'})`
              }}
            ...
            >
              ...
              {isTopRow && (
                <div
                  className="hidden md:block"
                  style={{ width: '2px', height: '24px', background: 'rgba(170,223,46,0.3)', order: 2 }}
                />
              )}
              ...
              >
                ...
                <h4
                  className="font-bebas text-xl text-text-primary"
                  style={{ marginBottom: '12px', letterSpacing: '0.04em' }}
                >
                  {p.title}
                </h4>
                <p
              ...
              {!isTopRow && (
                <div
                  className="hidden md:block"
                  style={{ width: '2px', height: '24px', background: 'rgba(170,223,46,0.3)', order: 1 }}
                />
              )}
            </div>
          )
...
export default function AFKHacksLandingPage() {
  const [activeTab, setActiveTab] = useState<'details' | 'domains'>('details')
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          SYS_STATUS: ACTIVE // LOC_PAN_ASIA
        </span>
        <span
          className="font-mono text-text-secondary"
      ...
      >
        <div className="wgc-container">
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            <span className="label-section accent">PAST SUCCESS</span>
            <h2
              className="font-heading font-black text-text-primary"
              style={{ fontSize: 'var(--type-h2)', marginTop: '8px' }}
            >
              A Legacy of High-Impact Events
            </h2>
          </div>
          ...
          >
            ...
            >
              <div style={{ position: 'relative', height: '240px', width: '100%' }}>
                <Image
                  src="/ethereum_meetup.png"
                  alt="Ethereum Ecosystem Meetup"
                  fill
              ...
              <div style={{ padding: '32px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
                  ...
                  >
                    METAMASK COLLABORATION
                  </span>
                  <div style={{ width: '4px', height: '4px', borderRadius: '50%', background: 'var(--bg-border)' }} />
                ...
                >
                  A specialized meetup hosted in collaboration with the MetaMask Ambassador community, uniting builders, founders, and Web3 enthusiasts across premier institutes.
                </p>
                ...
                >
                  <span
                    className="font-mono text-lime font-black"
                    style={{ fontSize: '24px', lineHeight: 1 }}
                  >
                    500+
                  </span>
                  <p className="font-body text-text-secondary" style={{ fontSize: '12px', margin: 0, lineHeight: 1.5 }}>
                    Students introduced to Web3 fundamentals, blockchain interaction, and NFT minting.
                  </p>
                </div>
              </div>
            </motion.div>

            {/* Event 2: General WGC Flagship Buildathons */}
            <motion.div
              initial={{ opacity: 0, scale: 0.98 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
            ...
            >
              <div style={{ position: 'relative', height: '240px', width: '100%' }}>
                <Image
                  src="/gaming_hackathon.png"
                  alt="WGC Qualifier Hackathons"
                  fill
                  style={{ objectFit: 'cover' }}
                />
                <div
              ...
              <div style={{ padding: '32px' }}>
                ...
                <p
                  ...
                  style={{ fontSize: '14px', lineHeight: 1.6, marginBottom: '20px' }}
                >
                  Establishing regional staging posts across 20+ major Asian hubs (Delhi, Seoul, Tokyo, Bangalore, Dubai), providing developers a launchpad into global gaming labs.
                </p>
                ...
                >
                  ...
                  <p className="font-body text-text-secondary" style={{ fontSize: '12px', margin: 0, lineHeight: 1.5 }}>
                    Active developer profiles registered with WGC ecosystems scaling projects for launch.
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      {/* ── 8. SLIDE-OVER REGISTRATION MODAL ───────────────────────────────────── */}
      <AnimatePresence>
        {modalOpen && (
          <div
            style={{
